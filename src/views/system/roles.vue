<template>
  <div class="app-container calendar-list-container role-tree">
    ...
    <el-table :key='tableKey' :data="roleList" v-loading.body="listLoading" border fit
              style="width: 100%">
    ...
    <el-dialog :title="textMap[dialogStatus]" :size="'tiny'" :close-on-click-modal="false" :visible.sync="dialogFormVisible">
      <el-form class="small-space role-form" :model="role" label-position="left" label-width="70px">
        <el-form-item class="role-form-item" label="名称">
          <el-input style="width: 90%;" class="filter-item" placeholder="请输入"
                    v-model="role.name">
          </el-input>
        </el-form-item>
        ...
        <el-form-item class="role-form-item" label="描述">
          <el-input style="width: 90%;" type="textarea" :autosize="{ minRows: 2, maxRows: 4}" placeholder="请输入内容"
    ...
    <el-dialog :title="'角色授权'" :size="'small'" :close-on-click-modal="false" :visible.sync="dlgAuthVisible" @close="handleRoleAuthCancel">
      <div style="margin-left: 5%; margin-right: 5%;">
        ...
        <el-row style="margin-top: 8px;">
          <el-col>
            <el-tree style="min-height: 300px;"
                     ref="funcTree"
                     :data="menuTree"
                     :props="authProps"
                     node-key="id"
