<template>
  <div class="app-container">
    ...
    <el-table v-loading.body="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column width="120px" align="center" label="Product_Type">
        <template slot-scope="scope">
      ...
      <el-table-column min-width="300px" label="Product_Synopsis">
        <template slot-scope="scope">
          <router-link :to="'/official-site/product/edit/'+scope.row.id" class="link-type">
            <span>{{ scope.row.productSynopsis }}</span>
          </router-link>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="Actions" width="260">
        <template slot-scope="scope">
          <router-link :to="'/official-site/product/edit/'+scope.row.id">
...
import { fetchList, deleteProduct, checkoutStatus } from '@/api/official-site/product/product'
